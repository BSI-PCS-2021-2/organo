      ...
      <div class="container-fluid">
        <div class="row d-flex justify-content-center">
          <div class="col-6 text-left text-justify">
            ...
            <p class="display-7">
              Método de pagamento:
              {{ fornecedorPedido.metodoPagamento.replace(/_/g, " ") }}
            </p>
            <br />
            <p class="display-7">
              Valor total: R$ {{ fornecedorPedido.valor.toLocaleString(2) }}
            </p>
            <br />
            <p class="display-7">
              Status: {{ fornecedorPedido.status.replace(/_/g, " ") }}
            </p>
            <br />
            <p class="display-7">
              Data de entrega: {{ fornecedorPedido.dataEntrega }}
            </p>
            <br />
            <p class="h3">Itens:</p>
            <br />
            <div class="container">
              <div
                class="mr-2 mb-4"
                v-for="item in fornecedorPedido.itens"
                :key="item.id"
              >
                <div class="row">
                  <div>
            ...
            <br />
            <div>
              <label class="h3" for="statusPedido" style="margin-bottom: 20px">
                Atualizar status do pedido:</label
              >
              <select
