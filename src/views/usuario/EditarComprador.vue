    ...
    <div class="container" style="padding-top: 5%; padding-bottom: 3%">
      <div class="row d-flex justify-content-center">
        <div class="col-5 text-left login-form-container">
         <p class="h3">Atualização de comprador</p>
          ...
          <div>
            <form>
                ...
                <button @click="atualizaComprador()" type="submit" class="btn btn-primary">Atualizar</button>
                <router-link
                    type="button"
...
export default {
  ...
  methods: {
    ...
    atualizaComprador() {
        ...
        this.atualizarComprador(comprador)
    },
    valCEP(e) {
  ...
  mounted() {
    this.cpf = this.comprador.cpf;
    this.nome = this.comprador.nome;
    this.email = this.comprador.email;
    this.senha = this.comprador.senha;
    this.sobrenome = this.comprador.sobrenome;
    this.celular = this.comprador.celular;
    this.cep = this.comprador.enderecos[0].cep;
    this.numero = this.comprador.enderecos[0].numero;
    this.rua = this.comprador.enderecos[0].rua;
    this.complemento = this.comprador.enderecos[0].complemento;
 }
};
</script>
<style>
