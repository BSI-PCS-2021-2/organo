          ...
          <div>
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" v-model="rua" class="form-control font-text form" id="inputRua" required>
                </div>
                <div class="form-group">
                    <label for="inputNumero">Número</label>
                    <input type="number" v-model="numero" class="form-control font-text form" id="inputNumero" required>
                </div>
                <div class="form-group">
                    <label for="inputComplemento">Complemento (opcional)</label>
                    <input type="text" v-model="complemento" class="form-control font-text form" id="inputComplemento">
                </div>
                <div class="form-group">
                    <label for="inputCep">CEP</label>
                    <input type="text" v-model="cep" class="form-control font-text form" id="inputCep" v-on:blur="valCEP" maxLength="8" required>
                </div>
                <br>
                <div class="form-group">
                    <button @click="atualizaFornecedor()" type="submit" class="btn btn-primary" style="display: inline; float: left;">Atualizar</button>
                    <router-link
                        type="button"
...
export default {
  ...
  methods: {
    ...mapActions("usuario", ["atualizarFornecedor", "verificaCEP", "resetVerificaCEP"]),
    atualizaFornecedor() {
  ...
  mounted() {
        ...
        this.entrega = (this.fornecedor.infoEntrega == 'ENTREGA_E_RETIRADA' || this.fornecedor.infoEntrega == 'ENTREGA') ? true : false;
        this.retirada = (this.fornecedor.infoEntrega == 'ENTREGA_E_RETIRADA' || this.fornecedor.infoEntrega == 'RETIRADA') ? true : false;
